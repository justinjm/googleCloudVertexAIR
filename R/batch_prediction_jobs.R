...
#' @param model an `trainingPipelineJob` object OR
...
#' @param gcsSource string Required. Google Cloud Storage URI(-s) to the input
#' file(s). May contain wildcards. For more information on wildcards,
#'  see https://cloud.google.com/storage/docs/gsutil/addlhelp/WildcardNames.
#' @param bigquerySource string Required. BigQuery URI to a project or table,
#' up to 2000 characters long.
#' When only the project is specified, the Dataset and Table is created.
#'  When the full table reference is specified,
...
#' @param bigqueryDestinationPrefix BigQuery path. For example: bq://projectId
#'  or bq://projectId.bqDatasetId or bq://projectId.bqDatasetId.bqTableId.
#' https://cloud.google.com/vertex-ai/docs/reference/rest/v1/projects.locations.batchPredictionJobs#BatchPredictionJob
#' @param sync If set to TRUE, the call will block while waiting for the
