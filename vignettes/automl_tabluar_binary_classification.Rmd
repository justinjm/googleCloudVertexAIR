...
API doc: https://cloud.google.com/vertex-ai/docs/reference/rest/v1/projects.locations.trainingPipelines#InputDataConfig

```{r}
gcva_automl_tabluar_training_job(displayName = "test1")
```
