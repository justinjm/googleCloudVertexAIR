...
TODO - move setup script  `data-raw/0_setup_vignettes.R` to here to create BQ dataset then create BQ table from the source dataset in GCS `california-housing-tabular-regression.csv`
